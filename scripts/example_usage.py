...
def print_commands() -> None:
    ...
    print("python -m src train --config configs/config.yaml --models cnn1d inception1d --epochs 5 --batch-size 16")
    print("python -m src evaluate --config configs/config.yaml --models cnn1d inception1d")
    print()
    print("Notes")
    print("-" * 50)
